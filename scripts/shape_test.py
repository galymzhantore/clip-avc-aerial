...
def main() -> None:
    ...
    parser.add_argument("--visual-pretraining", choices=SUPPORTED_VISUAL_PRETRAINING, default="wit")
    parser.add_argument("--clip-model", type=str, default="ViT-B/32")
    parser.add_argument("--imagenet-vit-model", choices=SUPPORTED_IMAGENET_VIT_MODELS, default="vit_b_32")
    ...
    parser.add_argument("--cross-transformer", action=argparse.BooleanOptionalAction, default=True)
